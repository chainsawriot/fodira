...
x <- academictwitteR:::get_all_tweets("from:jacobinmag_de", start_tweets = "2022-08-01T00:00:00Z", end_tweets = "2023-04-24T00:00:00Z", n = Inf, bind_tweets = FALSE, data_path = dir, is_retweet = FALSE)
