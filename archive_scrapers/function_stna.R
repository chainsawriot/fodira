...
x <- academictwitteR:::get_all_tweets("from:StZ_NEWS", start_tweets = "2021-12-31T00:00:00Z", end_tweets = "2022-09-02T00:00:00Z", n = Inf, bind_tweets = FALSE, data_path = dir, is_retweet = FALSE)
...
saveRDS(valid_links, "stuttgarter_Z_archive.RDS")
